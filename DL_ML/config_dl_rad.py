...
if data_mode == 'pathology_single_mul_bound3d_report_infiltration_3cls_AAHAIS_MIA_IAC':
    ...
    train_rad_dir = './dp_rad_train_AAHAIS_MIA_IAC.csv'
    val_set_dirs = [
    ...
    val_rad_dirs = [
        base_list_dir + 'dp_rad_val_AAHAIS_MIA_IAC.csv',
        base_list_dir + 'dp_rad_test_AAHAIS_MIA_IAC.csv',
        base_list_dir + 'xh_rad_test_AAHAIS_MIA_IAC.csv',
    ]
    val_set_dir_inf = ''
    save_csv = [
        './dp_data_val_AAHAIS_MIA_IAC_result.csv',
        './dp_data_test_AAHAIS_MIA_IAC_result.csv',
        './xh_data_test_AAHAIS_MIA_IAC_result.csv',
    ]
